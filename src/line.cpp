...
void line::draw(screen& s){
	...
	int A = (int) 2 * (p1[1]-p0[1]); int B = (int) -2 * (p1[0]-p0[0]);
	int d;
	int x = (int)p0[0]; int y = (int)p0[1];
	...
	double z = (double) (p0[2] / 100000 * 100000);
	double dz = ((double)(p1[2] - p0[2])) / ((int)(loop_end - loop_start));
